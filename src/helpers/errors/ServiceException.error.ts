...
type ServiceLayerErrorMessage = Array<{ [key: string | number]: Array<string> }> | string;

export class ServiceLayerError {
  readonly message: ServiceLayerErrorMessage = [];
  readonly name: string = "ServiceLayerError";
  readonly extraInfo: PostgresErrorCode | string | number | unknown;
  readonly statusCode: number;

  constructor(statusCode: HttpStatus, message?: ServiceLayerErrorMessage, extraInfo?: unknown) {
